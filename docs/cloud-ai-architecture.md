# Cloud + AI Architecture Blueprint: m365-copilot-adoption-command-center
...
- **Current proof surface:** Repository-local proof surface for agent runtime reliability and AI workflow orchestration, backed by Node/TypeScript runtime, Python service or lab runtime, Local compose environment.
- **Status:** archived-supporting
- **Primary stack:** Node/TypeScript runtime, Python service or lab runtime, Local compose environment, GitHub Actions validation
